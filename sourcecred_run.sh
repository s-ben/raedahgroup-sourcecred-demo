...
DEMO_DIR="/Users/sben/Documents/coins/sourcecred/raedahgroup-sourcecred-demo"
...
node "$SOURCECRED_CLI" load decred/dcrandroid raedahgroup/dcrlibwallet raedahgroup/godcr raedahgroup/dcrios --output raedahgroup/meta-raedahgroup
